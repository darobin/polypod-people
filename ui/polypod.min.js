...
// ui/stores/identities.js
var $loggedIn = atom(false);

// ui/el/title-bar.js
var PolypodTitleBar = class extends (0, import_lit113.withStores)(h3, [
  $loggedIn
  /*$uiSideBarShowing*/
]) {
  static styles = [
  ...
  render() {
    ...
    return ke`
      <div id="root" class=${open ? "open" : "closed"}>
        <div id="icon-bar">
          ${$loggedIn ? ke`<sl-icon-button name="layout-sidebar" label=${label} @click=${toggleSideBar}></sl-icon-button>` : D}
